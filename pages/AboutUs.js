                ...
                <div className="wrapper">
                    <div className="aboutUsTextAndImageContainer">
                        <div className="textContainer">
                            ...
                            <p>Policella Homes has worked with many of the trades for over 20 years and each of them have been carefully selected because of their drive for perfection in their field.   The unique trait of this family-run business is that both Vince Sr. and Vince Jr. are on site each and every day of the building process to ensure that the highest standards are met for each stage of development.</p>
                            ...
                            <p>At Policella Homes, we can custom design and build a beautiful new home to suit your lifestyle, needs and budget.</p>
                        </div>
